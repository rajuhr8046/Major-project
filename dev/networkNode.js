...
//const uuid = require('/home/raju/Desktop/blockchain/node_modules/uuid/package.json');
...
app.post('/createSideChain', function (req, res) {
	bitcoin = maincoin.createSideChain(req.body.id, req.body.amount);
